...
def center_protein_in_box(uni):
    ...
    protein_atoms = uni.select_atoms("protein")
    with mda.Writer("/home/annika/md_sims/final_extraction/no_in_memory_center.dcd", len(uni.atoms)) as dcd_writer:
...
with open('/home/annika/md_sims/final_extraction/change_config.json') as config_file:
...
if data["center"]:
    ...
    universe = mda.Universe(
        topology_file_path, '/home/annika/md_sims/final_extraction/no_in_memory_center.dcd')
